...
LeftNormE = [1  1.7  1.8  2.6  2.7  3.6  3.7  4.7  4.8];
...
ActiveSum = 7;
[AllSequence, BestInactive_Sequence] = VMT_GetAllPossibleSequence(LeftNormE, RightNormE, LeftComp, RightComp, OriginStatus, 3, ActiveSum, []);
